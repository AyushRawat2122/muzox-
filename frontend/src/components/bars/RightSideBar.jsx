...
const RightSideBar = () => {
  ...
  return (
    <div className="h-full flex relative flex-col w-full overflow-y-auto">
      <div className="pl-2 sticky capitalize font-semibold text-lg top-0 py-3 shadow-md shadow-[#50505082] flex items-center gap-2.5 z-10 bg-black/40">
        <PanelRightClose
        ...
        {isQueueDisplayed && (
          <div className="flex w-full gap-4 text-base items-center">
            ...
            <button
              ...
              className={`${!isRecentTabOpen ? "underline" : ""} capitalize underline-offset-7 decoration-2 decoration-[#07ffd69d]`}
            >
              queue
            </button>
            <button
